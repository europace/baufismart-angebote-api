...
## Deprecation Notice – Angebote API v1 & v2
##### ⚠️ Deprecated
The Angebote API versions v1 and v2 are deprecated and will be removed in a future release.
Please migrate to Angebote API v3. Some legacy features are no longer available and may require using the Vorschlaege API as an alternative.
