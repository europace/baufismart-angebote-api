...
public class Sparplaene {
  @JsonProperty("aktuellerWert")
  private BigDecimal aktuellerWert = null;

  @JsonProperty("beitragMonatlich")
  private BigDecimal beitragMonatlich = null;
  ...
  public Sparplaene aktuellerWert(BigDecimal aktuellerWert) {
  ...
  **/
  ...
  public Sparplaene beitragMonatlich(BigDecimal beitragMonatlich) {
    this.beitragMonatlich = beitragMonatlich;
    return this;
  }

   /**
   * Get beitragMonatlich
   * @return beitragMonatlich
  **/
  @ApiModelProperty(value = "")
  public BigDecimal getBeitragMonatlich() {
    return beitragMonatlich;
  }

  public void setBeitragMonatlich(BigDecimal beitragMonatlich) {
    this.beitragMonatlich = beitragMonatlich;
  }

  public Sparplaene ertrag(BigDecimal ertrag) {
    this.ertrag = ertrag;
    return this;
  }
  ...
  **/
  ...
  public Sparplaene maximalAufzuloesenderWert(BigDecimal maximalAufzuloesenderWert) {
  ...
  **/
  ...
  public Sparplaene vermoegensEinsatz(VermoegensEinsatzEnum vermoegensEinsatz) {
  ...
  **/
  ...
  public Sparplaene zukuenftigeEinnahmen(BigDecimal zukuenftigeEinnahmen) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Sparplaene sparplaene = (Sparplaene) o;
    return Objects.equals(this.aktuellerWert, sparplaene.aktuellerWert) &&
        Objects.equals(this.beitragMonatlich, sparplaene.beitragMonatlich) &&
        Objects.equals(this.ertrag, sparplaene.ertrag) &&
        Objects.equals(this.maximalAufzuloesenderWert, sparplaene.maximalAufzuloesenderWert) &&
        Objects.equals(this.vermoegensEinsatz, sparplaene.vermoegensEinsatz) &&
        Objects.equals(this.zukuenftigeEinnahmen, sparplaene.zukuenftigeEinnahmen);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aktuellerWert, beitragMonatlich, ertrag, maximalAufzuloesenderWert, vermoegensEinsatz, zukuenftigeEinnahmen);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sparplaene {\n");
    
    sb.append("    aktuellerWert: ").append(toIndentedString(aktuellerWert)).append("\n");
    sb.append("    beitragMonatlich: ").append(toIndentedString(beitragMonatlich)).append("\n");
