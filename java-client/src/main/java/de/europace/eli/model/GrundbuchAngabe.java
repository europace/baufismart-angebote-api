...
public class GrundbuchAngabe {
  ...
  private List<Flurstueck> flurstuecke = null;
  ...
  **/
  ...
  public GrundbuchAngabe addFlurstueckeItem(Flurstueck flurstueckeItem) {
    if (this.flurstuecke == null) {
      this.flurstuecke = new ArrayList<Flurstueck>();
    }
  ...
  **/
   ...
   * @return ort
  **/
  @ApiModelProperty(value = "Ort des als Grundbuchamt zuständigen Amtsgerichtes")
  ...
  **/
  @ApiModelProperty(value = "Belastungen und Beschränkungen in der Nutzbarkeit des Grundstücks. Leitungsrechte, Verzichte auf Abstandsflächen, Wegerechte, Insolvenzvermerke.")
